...
include_once $this->targetDirs[3].'\\src\\Repository\\ItemRepository.php';

return $this->privates['App\Repository\ItemRepository'] = new \App\Repository\ItemRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
