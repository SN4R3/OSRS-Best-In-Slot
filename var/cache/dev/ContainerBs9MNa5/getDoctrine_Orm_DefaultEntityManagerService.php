...
$a->setNamespace('sf_orm_default_8b87486941834d35816c6554ce7fcb4151507cea191c38fb9a3000fd216c0cd3');

$b = new \Doctrine\Common\Cache\ArrayCache();
$b->setNamespace('sf_orm_default_8b87486941834d35816c6554ce7fcb4151507cea191c38fb9a3000fd216c0cd3');

$c = new \Doctrine\Common\Cache\ArrayCache();
$c->setNamespace('sf_orm_default_8b87486941834d35816c6554ce7fcb4151507cea191c38fb9a3000fd216c0cd3');
...
$e->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\ItemRepository' => function () {
    return ($this->privates['App\Repository\ItemRepository'] ?? $this->load(__DIR__.'/getItemRepositoryService.php'));
}, 'App\\Repository\\StatsReqRepository' => function () {
    return ($this->privates['App\Repository\StatsReqRepository'] ?? $this->load(__DIR__.'/getStatsReqRepositoryService.php'));
}))));
