...
// Returns the private 'App\Repository\StatsReqRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\StatsReqRepository.php';

return $this->privates['App\Repository\StatsReqRepository'] = new \App\Repository\StatsReqRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
